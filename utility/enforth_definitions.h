...
0xC6,0xE6, 0xC8,0xFF, MINUS, 0xC6,0x8B, 0xC0,0x0A, FETCH, 0xC1,0xFE, EXIT,
...
QDUP, IZBRANCH, 21, DUP, CFETCH, OVER, DUP, 0xC8,0xFF, SWAP, MINUS, SWAP, CSTORE, QDUP, IZBRANCH, 4, MINUS, IBRANCH, 3, DROP, ZERO, IBRANCH, -22, EXIT,
...
VM, ICHARLIT, offsetof(EnforthVM, source_len), PLUS, TWOSTORE, ZERO, 0xC5,0x5A, STORE, 0xC6,0x7C, 0xCA,0x3E, DUP, IZBRANCH, 46, 0xC1,0x60, QDUP, IZBRANCH, 16, ONEPLUS, 0xCB,0xBE, FETCH, ZEROEQUALS, OR, IZBRANCH, 4, EXECUTE, IBRANCH, 28, 0xC6,0xE6, IBRANCH, 24, 0xC2,0xE8, IZBRANCH, 10, 0xCB,0xBE, FETCH, IZBRANCH, 15, 0xC9,0xA2, IBRANCH, 11, 0xCC,0x46, 0xCB,0x9E, ICHARLIT, '?', EMIT, 0xC7,0x31, ABORT, IBRANCH, -51, TWODROP, EXIT,
...
BASE, FETCH, 0xC3,0x50, ROT, DUP, ICHARLIT, 9, GREATERTHAN, ICHARLIT, 7, AND, PLUS, ICHARLIT, 48, PLUS, 0xC9,0x17, EXIT,
...
DROP, DROP, 0xC2,0x2B, FETCH, 0xC8,0xFF, 0xC2,0x34, PLUS, OVER, MINUS, EXIT,
...
0xC6,0x7C, 0xCA,0x3E, 0xC1,0x60, ZEROEQUALS, IZBRANCH, 11, 0xCC,0x46, 0xCB,0x9E, ICHARLIT, '?', EMIT, 0xC7,0x31, ABORT, EXIT,
...
ICHARLIT, ')', 0xCA,0x3E, TWODROP, EXIT,
...
TOR, 0xC9,0xDE, RFROM, 0xCB,0x71, EXIT,
...
0xC8,0xFF, STORE, ICHARLIT, 1, 0xC6,0xB1, 0xC6,0x57, EXIT,
...
BASE, FETCH, ICHARLIT, 10, NOTEQUALS, IZBRANCH, 4, 0xCC,0x5B, EXIT, DUP, ABS, ZERO, 0xC5,0x27, 0xC3,0xB8, ROT, 0xCB,0x5F, 0xC3,0xA5, 0xCC,0x46, 0xCB,0x9E, EXIT,
...
TOR, 0xCB,0x4C, RFROM, 0xCB,0x71, EXIT,
...
0xC7,0x3F, 0xC2,0x1A, ZERO, ONEMINUS, 0xC6,0x57, ICHARLIT, DOCOLON, 0xC6,0x8B, 0xCD,0xC3, EXIT,
...
ICHARLIT, EXIT, 0xC6,0xE6, 0xC3,0x26, 0xCD,0x8A, EXIT,
...
0xC8,0xFF, 0xC2,0x34, PLUS, 0xC2,0x2B, STORE, EXIT,
...
ICHARLIT, PQDO, 0xC6,0xE6, 0xC8,0xFF, 0xC0,0x0A, STORE, ZERO, 0xC6,0x8B, 0xC8,0xFF, EXIT,
...
OVER, PLUS, OVER, 0xC9,0x66, DUP, ICHARLIT, 10, NOTEQUALS, IZBRANCH, 44, DUP, ICHARLIT, 8, EQUALS, OVER, ICHARLIT, 127, EQUALS, OR, IZBRANCH, 19, TWOOVER, DROP, NIP, OVER, NOTEQUALS, IZBRANCH, 10, ONEMINUS, ICHARLIT, 8, EMIT, 0xCB,0x9E, ICHARLIT, 8, EMIT, IBRANCH, 13, DUP, TWOOVER, NOTEQUALS, IZBRANCH, 7, EMIT, OVER, CSTORE, ONEPLUS, IBRANCH, 2, TWODROP, IBRANCH, -50, DROP, NIP, SWAP, MINUS, EXIT,
...
ICHARLIT, BRANCH, 0xC6,0xE6, 0xC8,0xFF, MINUS, 0xC6,0x8B, EXIT,
...
0xC8,0xFF, CSTORE, ICHARLIT, 1, 0xC6,0xD9, 0xC6,0x57, EXIT,
...
0xC6,0x7C, 0xCA,0x3E, DROP, CFETCH, EXIT,
...
0xC6,0x7C, 0xCA,0x3E, DUP, ZEROEQUALS, IZBRANCH, 2, ABORT, TUCK, OVER, PLUS, ONEMINUS, DUP, CFETCH, ICHARLIT, 128, OR, 0xC6,0x8B, TWODUP, NOTEQUALS, IZBRANCH, 8, ONEMINUS, DUP, CFETCH, 0xC6,0x8B, IBRANCH, -10, TWODROP, 0xC8,0xFF, 0xC0,0x56, SWAP, 0xC6,0x8B, 0xC2,0xB4, FETCH, 0xC3,0x62, 0xC2,0xB4, STORE, ICHARLIT, DOCREATE, 0xC6,0x8B, 0xC6,0x41, EXIT,
...
ZERO, 0xC0,0x0A, STORE, ICHARLIT, PDO, 0xC6,0xE6, 0xC8,0xFF, EXIT,
...
BASE, FETCH, TOR, 0xC9,0x0A, QDUP, IZBRANCH, 98, TWODUP, ICHARLIT, 16, MIN, TUCK, 0xC7,0x31, OVER, ZERO, 0xC5,0x27, 0xC3,0x8C, 0xC3,0x8C, 0xC3,0x8C, 0xC3,0x8C, 0xC3,0x8C, 0xC3,0x8C, 0xC3,0x8C, 0xC3,0x8C, 0xC3,0xA5, 0xCC,0x46, ICHARLIT, 2, 0xCB,0xAC, DUP, ZERO, PDO, OVER, I, PLUS, CFETCH, ZERO, 0xC5,0x27, 0xC3,0x8C, 0xC3,0x8C, 0xC3,0xA5, 0xCC,0x46, 0xCB,0x9E, PILOOP, -18, ICHARLIT, 16, OVER, MINUS, ICHARLIT, 3, 0xC3,0xEA, 0xCB,0xAC, 0xCB,0x9E, ZERO, PDO, DUP, I, PLUS, CFETCH, DUP, ICHARLIT, 32, LESSTHAN, OVER, ICHARLIT, 127, GREATERTHAN, OR, IZBRANCH, 4, DROP, ICHARLIT, '.', EMIT, PILOOP, -20, DROP, 0xC4,0x77, IBRANCH, -99, DROP, RFROM, BASE, STORE, EXIT,

/* DUP */
0x80|'P', 'U', 'D',
#undef ROMDEF_LAST
#define ROMDEF_DUP 0xC85B
#define ROMDEF_LAST 0xC85B
3, 0xC7,0xE6, DUP,

/* ELSE */
0x80|'E', 'S', 'L', 'E',
#undef ROMDEF_LAST
#define ROMDEF_ELSE 0xC863
#define ROMDEF_LAST 0xC863
0x80|4, 0xC8,0x5B, DOCOLONROM,
ICHARLIT, BRANCH, 0xC6,0xE6, 0xC8,0xFF, ZERO, 0xC6,0x8B, SWAP, 0xCC,0x27, EXIT,

/* EMIT */
0x80|'T', 'I', 'M', 'E',
#undef ROMDEF_LAST
#define ROMDEF_EMIT 0xC878
...
0x80|'S', 'I', 'F', 'F',
#undef ROMDEF_LAST
#define ROMDEF_FFIS 0xC89C
#define ROMDEF_LAST 0xC89C
4, 0xC8,0x94, DOCOLONROM,
VM, ICHARLIT, offsetof(EnforthVM, last_ffi), PLUS, FETCH, QDUP, IZBRANCH, 14, DUP, 0xC1,0x20, OVER, 0xC1,0x29, 0xC2,0x92, 0xCB,0x9E, IFETCH, IBRANCH, -15, EXIT,

/* FIND */
0x80|'D', 'N', 'I', 'F',
#undef ROMDEF_LAST
#define ROMDEF_FIND 0xC8BA
#define ROMDEF_LAST 0xC8BA
4, 0xC8,0x9C, DOCOLONROM,
0xC7,0x25, 0xC1,0x60, EXIT,

/* FMSLASHMOD */
0x80|'D', 'O', 'M', '/', 'M', 'F',
#undef ROMDEF_LAST
#define ROMDEF_FMSLASHMOD 0xC8C9
#define ROMDEF_LAST 0xC8C9
6, 0xC8,0xBA, DOCOLONROM,
...
0x80|'E', 'R', 'E', 'H',
#undef ROMDEF_LAST
#define ROMDEF_HERE 0xC8FF
#define ROMDEF_LAST 0xC8FF
4, 0xC8,0xC9, DOCOLONROM,
0xC0,0xED, FETCH, EXIT,

/* HEX */
0x80|'X', 'E', 'H',
#undef ROMDEF_LAST
#define ROMDEF_HEX 0xC90A
#define ROMDEF_LAST 0xC90A
3, 0xC8,0xFF, DOCOLONROM,
ICHARLIT, 16, BASE, STORE, EXIT,

/* HOLD */
0x80|'D', 'L', 'O', 'H',
#undef ROMDEF_LAST
#define ROMDEF_HOLD 0xC917
#define ROMDEF_LAST 0xC917
4, 0xC9,0x0A, DOCOLONROM,
0xC2,0x2B, FETCH, ONEMINUS, DUP, 0xC2,0x2B, STORE, CSTORE, EXIT,

/* I */
0x80|'I',
#undef ROMDEF_LAST
#define ROMDEF_I 0xC926
#define ROMDEF_LAST 0xC926
1, 0xC9,0x17, I,

/* IF */
0x80|'F', 'I',
#undef ROMDEF_LAST
#define ROMDEF_IF 0xC92C
#define ROMDEF_LAST 0xC92C
0x80|2, 0xC9,0x26, DOCOLONROM,
ICHARLIT, ZBRANCH, 0xC6,0xE6, 0xC8,0xFF, ZERO, 0xC6,0x8B, EXIT,

/* IMMEDIATE */
0x80|'E', 'T', 'A', 'I', 'D', 'E', 'M', 'M', 'I',
#undef ROMDEF_LAST
#define ROMDEF_IMMEDIATE 0xC943
#define ROMDEF_LAST 0xC943
9, 0xC9,0x2C, DOCOLONROM,
0xC2,0xB4, FETCH, 0xC0,0x4B, DUP, CFETCH, ICHARLIT, 128, OR, SWAP, CSTORE, EXIT,

/* INVERT */
0x80|'T', 'R', 'E', 'V', 'N', 'I',
#undef ROMDEF_LAST
#define ROMDEF_INVERT 0xC95A
...
0x80|'J',
#undef ROMDEF_LAST
#define ROMDEF_J 0xC95F
#define ROMDEF_LAST 0xC95F
1, 0xC9,0x5A, J,

/* KEY */
0x80|'Y', 'E', 'K',
#undef ROMDEF_LAST
#define ROMDEF_KEY 0xC966
#define ROMDEF_LAST 0xC966
3, 0xC9,0x5F, DOCOLONROM,
PAUSE, KEYQ, IZBRANCH, -3, PKEY, EXIT,

/* KEYQ */
0x80|'?', 'Y', 'E', 'K',
#undef ROMDEF_LAST
#define ROMDEF_KEYQ 0xC974
...
0x80|'E', 'V', 'A', 'E', 'L',
#undef ROMDEF_LAST
#define ROMDEF_LEAVE 0xC97D
#define ROMDEF_LAST 0xC97D
0x80|5, 0xC9,0x74, DOCOLONROM,
ICHARLIT, UNLOOP, 0xC6,0xE6, ICHARLIT, BRANCH, 0xC6,0xE6, 0xC8,0xFF, 0xC0,0x0A, FETCH, DUP, IZBRANCH, 5, 0xC8,0xFF, SWAP, MINUS, 0xC6,0x8B, 0xC0,0x0A, STORE, EXIT,

/* LITERAL */
0x80|'L', 'A', 'R', 'E', 'T', 'I', 'L',
#undef ROMDEF_LAST
#define ROMDEF_LITERAL 0xC9A2
#define ROMDEF_LAST 0xC9A2
0x80|7, 0xC9,0x7D, DOCOLONROM,
...
0x80|'P', 'O', 'O', 'L',
#undef ROMDEF_LAST
#define ROMDEF_LOOP 0xC9C9
#define ROMDEF_LAST 0xC9C9
0x80|4, 0xC9,0xC1, DOCOLONROM,
ICHARLIT, PLOOP, 0xC0,0xF4, EXIT,

/* LSHIFT */
0x80|'T', 'F', 'I', 'H', 'S', 'L',
#undef ROMDEF_LAST
#define ROMDEF_LSHIFT 0xC9D8
#define ROMDEF_LAST 0xC9D8
6, 0xC9,0xC9, LSHIFT,

/* MSTAR */
0x80|'*', 'M',
#undef ROMDEF_LAST
#define ROMDEF_MSTAR 0xC9DE
#define ROMDEF_LAST 0xC9DE
2, 0xC9,0xD8, DOCOLONROM,
TWODUP, XOR, ZEROLESS, TOR, ABS, SWAP, ABS, UMSTAR, RFROM, 0xC0,0x61, EXIT,

/* MPLUS */
0x80|'+', 'M',
#undef ROMDEF_LAST
#define ROMDEF_MPLUS 0xC9F0
...
0x80|'D', 'O', 'M',
#undef ROMDEF_LAST
#define ROMDEF_MOD 0xCA05
#define ROMDEF_LAST 0xCA05
3, 0xC9,0xFE, DOCOLONROM,
0xC4,0x65, DROP, EXIT,

/* MOVE */
0x80|'E', 'V', 'O', 'M',
#undef ROMDEF_LAST
#define ROMDEF_MOVE 0xCA11
...
0x80|'E', 'T', 'A', 'G', 'E', 'N',
#undef ROMDEF_LAST
#define ROMDEF_NEGATE 0xCA1B
#define ROMDEF_LAST 0xCA1B
6, 0xCA,0x11, NEGATE,

/* NIP */
0x80|'P', 'I', 'N',
#undef ROMDEF_LAST
#define ROMDEF_NIP 0xCA22
#define ROMDEF_LAST 0xCA22
3, 0xCA,0x1B, NIP,

/* OR */
0x80|'R', 'O',
#undef ROMDEF_LAST
#define ROMDEF_OR 0xCA28
...
0x80|'R', 'E', 'V', 'O',
#undef ROMDEF_LAST
#define ROMDEF_OVER 0xCA30
#define ROMDEF_LAST 0xCA30
4, 0xCA,0x28, OVER,

/* PARSEWORD */
0x80|'D', 'R', 'O', 'W', '-', 'E', 'S', 'R', 'A', 'P',
#undef ROMDEF_LAST
#define ROMDEF_PARSEWORD 0xCA3E
#define ROMDEF_LAST 0xCA3E
10, 0xCA,0x30, DOCOLONROM,
TOR, 0xCB,0x8F, 0xC5,0x5A, FETCH, 0xC4,0x77, RFETCH, TOR, OVER, CFETCH, RFETCH, EQUALS, OVER, AND, IZBRANCH, 7, ICHARLIT, 1, 0xC4,0x77, IBRANCH, -13, RFROM, DROP, OVER, SWAP, RFROM, TOR, DUP, ZEROEQUALS, IZBRANCH, 6, RFROM, TWODROP, FALSE, IBRANCH, 18, OVER, CFETCH, RFETCH, EQUALS, IZBRANCH, 6, RFROM, TWODROP, TRUE, IBRANCH, 7, ICHARLIT, 1, 0xC4,0x77, IBRANCH, -25, OVER, 0xCB,0x8F, DROP, MINUS, SWAP, IZBRANCH, 2, ONEPLUS, 0xC5,0x5A, STORE, OVER, MINUS, EXIT,

/* PAUSE */
0x80|'E', 'S', 'U', 'A', 'P',
#undef ROMDEF_LAST
#define ROMDEF_PAUSE 0xCA8E
...
#undef ROMDEF_LAST
#define ROMDEF_POSTPONE 0xCA9A
#define ROMDEF_LAST 0xCA9A
0x80|8, 0xCA,0x8E, DOCOLONROM,
0xC6,0x7C, 0xCA,0x3E, 0xC1,0x60, QDUP, ZEROEQUALS, IZBRANCH, 11, 0xCC,0x46, 0xCB,0x9E, ICHARLIT, '?', EMIT, 0xC7,0x31, ABORT, ZEROLESS, IZBRANCH, 19, ICHARLIT, LIT, 0xC6,0xE6, 0xC4,0x25, ICHARLIT, ((uint8_t)((ROMDEF_COMPILECOMMA >> 8) & 0xff)), ICHARLIT, 8, LSHIFT, ICHARLIT, ((uint8_t)((ROMDEF_COMPILECOMMA     ) & 0xff)), OR, 0xC3,0x62, IBRANCH, 3, 0xC6,0xE6, EXIT,

/* QUIT */
0x80|'T', 'I', 'U', 'Q',
#undef ROMDEF_LAST
#define ROMDEF_QUIT 0xCACE
#define ROMDEF_LAST 0xCACE
4, 0xCA,0x9A, DOCOLONROM,
INITRP, ZERO, 0xCB,0xBE, STORE, 0xC3,0x37, DUP, 0xC3,0x40, 0xC5,0xEA, 0xCB,0x9E, 0xC2,0x4F, 0xC7,0x31, 0xCB,0xBE, FETCH, ZEROEQUALS, IZBRANCH, 8, PISQUOTE, 3, 'o', 'k', ' ', 0xC2,0x92, IBRANCH, -27,

/* RFROM */
0x80|'>', 'R',
#undef ROMDEF_LAST
#define ROMDEF_RFROM 0xCAF5
...
0x80|'E', 'S', 'R', 'U', 'C', 'E', 'R',
#undef ROMDEF_LAST
#define ROMDEF_RECURSE 0xCB06
#define ROMDEF_LAST 0xCB06
0x80|7, 0xCA,0xFB, DOCOLONROM,
0xC2,0xB4, FETCH, 0xC3,0x62, EXIT,

/* REPEAT */
0x80|'T', 'A', 'E', 'P', 'E', 'R',
#undef ROMDEF_LAST
#define ROMDEF_REPEAT 0xCB16
#define ROMDEF_LAST 0xCB16
0x80|6, 0xCB,0x06, DOCOLONROM,
0xC6,0x2E, 0xCC,0x27, EXIT,

/* ROT */
0x80|'T', 'O', 'R',
#undef ROMDEF_LAST
#define ROMDEF_ROT 0xCB22
#define ROMDEF_LAST 0xCB22
3, 0xCB,0x16, ROT,

/* RSHIFT */
0x80|'T', 'F', 'I', 'H', 'S', 'R',
#undef ROMDEF_LAST
#define ROMDEF_RSHIFT 0xCB2C
...
0x80|'"', 'S',
#undef ROMDEF_LAST
#define ROMDEF_SQUOTE 0xCB32
#define ROMDEF_LAST 0xCB32
0x80|2, 0xCB,0x2C, DOCOLONROM,
ICHARLIT, '"', 0xCA,0x3E, ICHARLIT, PSQUOTE, 0xC6,0xE6, DUP, 0xC6,0x8B, 0xC8,0xFF, OVER, 0xC6,0x57, SWAP, MOVE, EXIT,

/* STOD */
0x80|'D', '>', 'S',
#undef ROMDEF_LAST
#define ROMDEF_STOD 0xCB4C
#define ROMDEF_LAST 0xCB4C
3, 0xCB,0x32, DOCOLONROM,
DUP, ZEROLESS, EXIT,

/* SAVE */
0x80|'E', 'V', 'A', 'S',
#undef ROMDEF_LAST
#define ROMDEF_SAVE 0xCB57
#define ROMDEF_LAST 0xCB57
4, 0xCB,0x4C, SAVE,

/* SIGN */
0x80|'N', 'G', 'I', 'S',
#undef ROMDEF_LAST
#define ROMDEF_SIGN 0xCB5F
#define ROMDEF_LAST 0xCB5F
4, 0xCB,0x57, DOCOLONROM,
ZEROLESS, IZBRANCH, 5, ICHARLIT, '-', 0xC9,0x17, EXIT,

/* SMSLASHREM */
0x80|'M', 'E', 'R', '/', 'M', 'S',
#undef ROMDEF_LAST
#define ROMDEF_SMSLASHREM 0xCB71
#define ROMDEF_LAST 0xCB71
6, 0xCB,0x5F, DOCOLONROM,
OVER, TOR, TWODUP, XOR, TOR, ABS, TOR, 0xC7,0x95, RFROM, UMSLASHMOD, RFROM, 0xC0,0x6B, SWAP, RFROM, 0xC0,0x6B, SWAP, EXIT,

/* SOURCE */
0x80|'E', 'C', 'R', 'U', 'O', 'S',
#undef ROMDEF_LAST
#define ROMDEF_SOURCE 0xCB8F
#define ROMDEF_LAST 0xCB8F
6, 0xCB,0x71, DOCOLONROM,
VM, ICHARLIT, offsetof(EnforthVM, source_len), PLUS, TWOFETCH, EXIT,

/* SPACE */
0x80|'E', 'C', 'A', 'P', 'S',
#undef ROMDEF_LAST
#define ROMDEF_SPACE 0xCB9E
#define ROMDEF_LAST 0xCB9E
5, 0xCB,0x8F, DOCOLONROM,
0xC6,0x7C, EMIT, EXIT,

/* SPACES */
0x80|'S', 'E', 'C', 'A', 'P', 'S',
#undef ROMDEF_LAST
#define ROMDEF_SPACES 0xCBAC
#define ROMDEF_LAST 0xCBAC
6, 0xCB,0x9E, DOCOLONROM,
QDUP, IZBRANCH, 6, 0xCB,0x9E, ONEMINUS, IBRANCH, -7, EXIT,

/* STATE */
0x80|'E', 'T', 'A', 'T', 'S',
#undef ROMDEF_LAST
#define ROMDEF_STATE 0xCBBE
#define ROMDEF_LAST 0xCBBE
5, 0xCB,0xAC, DOCOLONROM,
VM, ICHARLIT, offsetof(EnforthVM, state), PLUS, EXIT,

/* SWAP */
0x80|'P', 'A', 'W', 'S',
#undef ROMDEF_LAST
#define ROMDEF_SWAP 0xCBCB
#define ROMDEF_LAST 0xCBCB
4, 0xCB,0xBE, SWAP,

/* TASK */
0x80|'K', 'S', 'A', 'T',
#undef ROMDEF_LAST
#define ROMDEF_TASK 0xCBD3
#define ROMDEF_LAST 0xCBD3
4, 0xCB,0xCB, DOCOLONROM,
0xC8,0xFF, 0xC2,0xA9, FETCH, 0xC4,0x25, DUP, 0xC2,0xA9, STORE, ICHARLIT, 8, 0xC6,0xB1, PLUS, ICHARLIT, 32, 0xC6,0xB1, PLUS, ICHARLIT, 20, 0xC6,0xB1, PLUS, 0xC4,0x25, ICHARLIT, 10, 0xC4,0x25, ICHARLIT, 5, 0xC6,0xB1, 0xC6,0x57, ICHARLIT, 32, 0xC6,0xB1, 0xC6,0x57, ICHARLIT, 20, 0xC6,0xB1, 0xC6,0x57, 0xC5,0x49, 0xC4,0x25, 0xC2,0xA9, FETCH, ICHARLIT, 8, 0xC6,0xB1, PLUS, ICHARLIT, 31, 0xC6,0xB1, PLUS, 0xC4,0x25, ZERO, 0xC4,0x25, ZERO, 0xC4,0x25, EXIT,

/* THEN */
0x80|'N', 'E', 'H', 'T',
#undef ROMDEF_LAST
#define ROMDEF_THEN 0xCC27
#define ROMDEF_LAST 0xCC27
0x80|4, 0xCB,0xD3, DOCOLONROM,
0xC8,0xFF, OVER, MINUS, SWAP, CSTORE, EXIT,

/* TRUE */
0x80|'E', 'U', 'R', 'T',
#undef ROMDEF_LAST
#define ROMDEF_TRUE 0xCC36
#define ROMDEF_LAST 0xCC36
4, 0xCC,0x27, TRUE,

/* TUCK */
0x80|'K', 'C', 'U', 'T',
#undef ROMDEF_LAST
#define ROMDEF_TUCK 0xCC3E
#define ROMDEF_LAST 0xCC3E
4, 0xCC,0x36, TUCK,

/* TYPE */
0x80|'E', 'P', 'Y', 'T',
#undef ROMDEF_LAST
#define ROMDEF_TYPE 0xCC46
#define ROMDEF_LAST 0xCC46
4, 0xCC,0x3E, DOCOLONROM,
OVER, PLUS, SWAP, TWODUP, NOTEQUALS, IZBRANCH, 7, DUP, CFETCH, EMIT, ONEPLUS, IBRANCH, -9, TWODROP, EXIT,

/* UDOT */
0x80|'.', 'U',
#undef ROMDEF_LAST
#define ROMDEF_UDOT 0xCC5B
#define ROMDEF_LAST 0xCC5B
2, 0xCC,0x46, DOCOLONROM,
ZERO, 0xC5,0x27, 0xC3,0xB8, 0xC3,0xA5, 0xCC,0x46, 0xCB,0x9E, EXIT,

/* ULESSTHAN */
0x80|'<', 'U',
#undef ROMDEF_LAST
#define ROMDEF_ULESSTHAN 0xCC6D
#define ROMDEF_LAST 0xCC6D
2, 0xCC,0x5B, ULESSTHAN,

/* UGREATERTHAN */
0x80|'>', 'U',
#undef ROMDEF_LAST
#define ROMDEF_UGREATERTHAN 0xCC73
#define ROMDEF_LAST 0xCC73
2, 0xCC,0x6D, UGREATERTHAN,

/* UDDOT */
0x80|'.', 'D', 'U',
#undef ROMDEF_LAST
#define ROMDEF_UDDOT 0xCC7A
#define ROMDEF_LAST 0xCC7A
3, 0xCC,0x73, DOCOLONROM,
0xC5,0x27, 0xC3,0xB8, 0xC3,0xA5, 0xCC,0x46, 0xCB,0x9E, EXIT,

/* UMSTAR */
0x80|'*', 'M', 'U',
#undef ROMDEF_LAST
#define ROMDEF_UMSTAR 0xCC8C
#define ROMDEF_LAST 0xCC8C
3, 0xCC,0x7A, UMSTAR,

/* UMSLASHMOD */
0x80|'D', 'O', 'M', '/', 'M', 'U',
#undef ROMDEF_LAST
#define ROMDEF_UMSLASHMOD 0xCC96
#define ROMDEF_LAST 0xCC96
6, 0xCC,0x8C, UMSLASHMOD,

/* UNLOOP */
0x80|'P', 'O', 'O', 'L', 'N', 'U',
#undef ROMDEF_LAST
#define ROMDEF_UNLOOP 0xCCA0
#define ROMDEF_LAST 0xCCA0
6, 0xCC,0x96, UNLOOP,

/* UNTIL */
0x80|'L', 'I', 'T', 'N', 'U',
#undef ROMDEF_LAST
#define ROMDEF_UNTIL 0xCCA9
#define ROMDEF_LAST 0xCCA9
0x80|5, 0xCC,0xA0, DOCOLONROM,
ICHARLIT, ZBRANCH, 0xC6,0xE6, 0xC8,0xFF, MINUS, 0xC6,0x8B, EXIT,

/* UNUSED */
0x80|'D', 'E', 'S', 'U', 'N', 'U',
#undef ROMDEF_LAST
#define ROMDEF_UNUSED 0xCCBD
#define ROMDEF_LAST 0xCCBD
6, 0xCC,0xA9, DOCOLONROM,
VM, ICHARLIT, offsetof(EnforthVM, dictionary), PLUS, FETCH, VM, ICHARLIT, offsetof(EnforthVM, dictionary_size), PLUS, FETCH, PLUS, 0xC8,0xFF, MINUS, EXIT,

/* USE */
0x80|':', 'E', 'S', 'U',
#undef ROMDEF_LAST
#define ROMDEF_USE 0xCCD4
#define ROMDEF_LAST 0xCCD4
4, 0xCC,0xBD, DOCOLONROM,
0xC6,0x7C, 0xCA,0x3E, DUP, ZEROEQUALS, IZBRANCH, 2, ABORT, TWODUP, 0xC1,0x3A, ZEROEQUALS, IZBRANCH, 11, 0xCC,0x46, 0xCB,0x9E, ICHARLIT, '?', EMIT, 0xC7,0x31, ABORT, 0xC8,0xFF, 0xC0,0x56, ROT, ICHARLIT, 32, OR, 0xC6,0x8B, 0xC2,0xB4, FETCH, 0xC3,0x62, 0xC2,0xB4, STORE, ICHARLIT, DOFFI0, OVER, 0xC1,0x17, PLUS, 0xC6,0x8B, 0xC6,0x41, 0xC4,0x25, DROP, EXIT,

/* VARIABLE */
0x80|'E', 'L', 'B', 'A', 'I', 'R', 'A', 'V',
#undef ROMDEF_LAST
#define ROMDEF_VARIABLE 0xCD19
#define ROMDEF_LAST 0xCD19
8, 0xCC,0xD4, DOCOLONROM,
0xC7,0x3F, ZERO, ONEMINUS, 0xC6,0x57, ICHARLIT, DOVARIABLE, 0xC6,0x8B, ZERO, 0xC4,0x25, EXIT,

/* WHILE */
0x80|'E', 'L', 'I', 'H', 'W',
#undef ROMDEF_LAST
#define ROMDEF_WHILE 0xCD30
#define ROMDEF_LAST 0xCD30
0x80|5, 0xCD,0x19, DOCOLONROM,
0xC9,0x2C, SWAP, EXIT,

/* WORDS */
0x80|'S', 'D', 'R', 'O', 'W',
#undef ROMDEF_LAST
#define ROMDEF_WORDS 0xCD3D
#define ROMDEF_LAST 0xCD3D
5, 0xCD,0x30, DOCOLONROM,
0xC2,0xB4, FETCH, QDUP, IZBRANCH, 59, DUP, 0xC1,0x0C, IZBRANCH, 16, DUP, 0xC0,0x43, DUP, 0xC1,0x20, SWAP, 0xC1,0x29, 0xC2,0x92, 0xCB,0x9E, IBRANCH, 35, DUP, 0xC0,0x78, ICHARLIT, 64, AND, ZEROEQUALS, IZBRANCH, 28, DUP, DUP, 0xC2,0xCE, OVER, SWAP, MINUS, SWAP, TWODUP, NOTEQUALS, IZBRANCH, 11, ONEMINUS, DUP, 0xC0,0x78, ICHARLIT, 127, AND, EMIT, IBRANCH, -13, TWODROP, 0xCB,0x9E, 0xC2,0xBD, IBRANCH, -60, EXIT,

/* XOR */
0x80|'R', 'O', 'X',
#undef ROMDEF_LAST
#define ROMDEF_XOR 0xCD85
#define ROMDEF_LAST 0xCD85
3, 0xCD,0x3D, XOR,

/* LTBRACKET */
0x80|'[',
#undef ROMDEF_LAST
#define ROMDEF_LTBRACKET 0xCD8A
#define ROMDEF_LAST 0xCD8A
0x80|1, 0xCD,0x85, DOCOLONROM,
FALSE, 0xCB,0xBE, STORE, EXIT,

/* BRACKETTICK */
0x80|']', '\'', '[',
#undef ROMDEF_LAST
#define ROMDEF_BRACKETTICK 0xCD96
#define ROMDEF_LAST 0xCD96
0x80|3, 0xCD,0x8A, DOCOLONROM,
0xC3,0xC6, ICHARLIT, LIT, 0xC6,0xE6, 0xC4,0x25, EXIT,

/* BRACKETCHAR */
0x80|']', 'R', 'A', 'H', 'C', '[',
#undef ROMDEF_LAST
#define ROMDEF_BRACKETCHAR 0xCDA9
#define ROMDEF_LAST 0xCDA9
0x80|6, 0xCD,0x96, DOCOLONROM,
0xC6,0xBE, ICHARLIT, CHARLIT, 0xC6,0xE6, 0xC6,0x8B, EXIT,

/* BACKSLASH */
0x80|'\\',
#undef ROMDEF_LAST
#define ROMDEF_BACKSLASH 0xCDB7
#define ROMDEF_LAST 0xCDB7
0x80|1, 0xCD,0xA9, DOCOLONROM,
0xCB,0x8F, NIP, 0xC5,0x5A, STORE, EXIT,

/* RTBRACKET */
0x80|']',
#undef ROMDEF_LAST
#define ROMDEF_RTBRACKET 0xCDC3
#define ROMDEF_LAST 0xCDC3
1, 0xCD,0xB7, DOCOLONROM,
TRUE, 0xCB,0xBE, STORE, EXIT,
