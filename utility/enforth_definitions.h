...
/* CHAR */
BL, PARSEWORD, DROP, CFETCH, EXIT, 0, 0, 0,
...
/* CONSTANT */
CREATE, ICHARLIT, kDefTypeCONSTANT, CHANGELATESTDEFTYPE, COMMA, EXIT, 0, 0,
...
/* DECIMAL */
ICHARLIT, 10, BASE, STORE, EXIT, 0, 0, 0,

/* ELSE */
ICHARLIT, BRANCH, COMPILECOMMA, HERE, ZERO, CCOMMA, SWAP, THEN, EXIT, 0, 0, 0, 0, 0, 0, 0,
...
/* IF */
ICHARLIT, ZBRANCH, COMPILECOMMA, HERE, ZERO, CCOMMA, EXIT, 0,
...
/* SQUOTE */
ICHARLIT, '"', PARSEWORD, ICHARLIT, PSQUOTE, COMPILECOMMA, DUP, CCOMMA, HERE, OVER, ALLOT, SWAP, MOVE, EXIT, 0, 0,
...
/* THEN */
HERE, OVER, MINUS, SWAP, CSTORE, EXIT, 0, 0,
...
/* VARIABLE */
CREATE, ICHARLIT, kDefTypeVARIABLE, CHANGELATESTDEFTYPE, ZERO, COMMA, EXIT, 0,
...
/* BRACKETCHAR */
CHAR, ICHARLIT, CHARLIT, COMPILECOMMA, CCOMMA, EXIT, 0, 0,
