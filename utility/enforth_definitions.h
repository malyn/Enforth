...
/* FOUNDFFIQ */
FFINAME, SWAP, QDUP, ZBRANCH, 22, ONEMINUS, TOR, OVER, CFETCH, OVER, CFETCHFFIDEFS, CNOTSIMILAR, ZBRANCH, 6, TWODROP, RFROM, DROP, FALSE, EXIT, ONEPLUS, SWAP, ONEPLUS, SWAP, RFROM, BRANCH, -23, TWODROP, TRUE, EXIT, 0,
