...
0xC0,0xA1, 0xC7,0xCF, DUP, ZEROEQUALS, IZBRANCH, 2, ABORT, TWODUP, 0xC4,0x14, ZEROEQUALS, IZBRANCH, 11, 0xCB,0x05, 0xC9,0x8A, ICHARLIT, '?', EMIT, 0xC1,0xB5, ABORT, 0xC5,0x9C, 0xCA,0xF3, 0xC6,0x95, FETCH, 0xCC,0x2C, 0xC6,0x95, STORE, SWAP, ICHARLIT, 32, OR, 0xC0,0xCD, ICHARLIT, DOFFI0, OVER, 0xC3,0x61, PLUS, 0xC0,0xCD, 0xC0,0x5C, 0xC1,0x65, DROP, EXIT,
