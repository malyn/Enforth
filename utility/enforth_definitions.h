...
/* TOTOKEN */
DUP, TOKENQ, ZBRANCH, 2, EXIT, DUP, FFIQ, ZBRANCH, 7, FFIARITY, CHARLIT, 232, PLUS, BRANCH, 5, TODEFTYPE, CHARLIT, 224, PLUS, EXIT, 0, 0, 0, 0,
...
/* DIGITQ */
CHARLIT, '0', MINUS, DUP, ZEROLESS, ZBRANCH, 4, DROP, ZERO, EXIT, DUP, CHARLIT, 9, GREATERTHAN, ZBRANCH, 13, DUP, CHARLIT, 17, LESSTHAN, ZBRANCH, 4, DROP, FALSE, EXIT, CHARLIT, 7, MINUS, DUP, ONEPLUS, BASE, FETCH, UGREATERTHAN, ZBRANCH, 4, DROP, FALSE, EXIT, TRUE, EXIT, 0, 0,

/* FFIARITY */
TOFFIDEF, CHARLIT, offsetof(EnforthFFIDef, arity), PLUS, CFETCHFFIDEFS, EXIT,

/* FFINAME */
TOFFIDEF, CHARLIT, offsetof(EnforthFFIDef, name), PLUS, FETCHFFIDEFS, EXIT,
...
/* FOUNDFFIQ */
FFINAME, SWAP, QDUP, ZBRANCH, 21, ONEMINUS, TOR, OVER, CFETCH, OVER, CFETCHFFIDEFS, CNOTSIMILAR, ZBRANCH, 6, TWODROP, RFROM, DROP, FALSE, EXIT, ONEPLUS, SWAP, ONEPLUS, RFROM, BRANCH, -22, TWODROP, TRUE, EXIT, 0, 0,
...
/* NUMBERQ */
ZERO, ZERO, TWOSWAP, TONUMBER, TWODROP, DROP, TRUE, EXIT, 0, 0, 0, 0,
