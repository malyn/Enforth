...
/* WORDS */
LATEST, FETCH, QDUP, ZBRANCH, 24, DUP, FFIQ, ZBRANCH, 10, DUP, TOFFIDEF, DUP, FFIDEFNAME, SWAP, FFIDEFNAMELEN, TYPE, BRANCH, 6, DUP, TONFA, OVER, NFALENGTH, TYPE, SPACE, TOLFA, WFETCH, BRANCH, -25, TICKNAMES, DUP, CFETCH, CHARLIT, 255, NOTEQUALS, ZBRANCH, 23, DUP, CFETCH, CHARLIT, 3, RSHIFT, TUCK, OVER, PLUS, ONEPLUS, SWAP, ONEPLUS, ROT, QDUP, ZBRANCH, 5, TYPE, SPACE, BRANCH, 2, DROP, BRANCH, -28, DROP, EXIT,
