...
VM, ICHARLIT, offsetof(EnforthVM, source_len), PLUS, TWOSTORE, ZERO, 0xC5,0x5A, STORE, 0xC6,0x7C, 0xCA,0x38, DUP, IZBRANCH, 46, 0xC1,0x60, QDUP, IZBRANCH, 16, ONEPLUS, 0xCB,0xA7, FETCH, ZEROEQUALS, OR, IZBRANCH, 4, EXECUTE, IBRANCH, 28, 0xC6,0xE6, IBRANCH, 24, 0xC2,0xE8, IZBRANCH, 10, 0xCB,0xA7, FETCH, IZBRANCH, 15, 0xC9,0x9C, IBRANCH, 11, 0xCC,0x2F, 0xCB,0x87, ICHARLIT, '?', EMIT, 0xC7,0x31, ABORT, IBRANCH, -51, TWODROP, EXIT,
...
0xC6,0x7C, 0xCA,0x38, 0xC1,0x60, ZEROEQUALS, IZBRANCH, 11, 0xCC,0x2F, 0xCB,0x87, ICHARLIT, '?', EMIT, 0xC7,0x31, ABORT, EXIT,
...
ICHARLIT, ')', 0xCA,0x38, TWODROP, EXIT,
...
TOR, 0xC9,0xD8, RFROM, 0xCB,0x5A, EXIT,
...
BASE, FETCH, ICHARLIT, 10, NOTEQUALS, IZBRANCH, 4, 0xCC,0x44, EXIT, DUP, ABS, ZERO, 0xC5,0x27, 0xC3,0xB8, ROT, 0xCB,0x48, 0xC3,0xA5, 0xCC,0x2F, 0xCB,0x87, EXIT,
...
TOR, 0xCB,0x35, RFROM, 0xCB,0x5A, EXIT,
...
0xC7,0x3F, 0xC2,0x1A, ZERO, ONEMINUS, 0xC6,0x57, ICHARLIT, DOCOLON, 0xC6,0x8B, 0xCD,0x99, EXIT,
...
ICHARLIT, EXIT, 0xC6,0xE6, 0xC3,0x26, 0xCD,0x60, EXIT,
...
OVER, PLUS, OVER, 0xC9,0x60, DUP, ICHARLIT, 10, NOTEQUALS, IZBRANCH, 44, DUP, ICHARLIT, 8, EQUALS, OVER, ICHARLIT, 127, EQUALS, OR, IZBRANCH, 19, TWOOVER, DROP, NIP, OVER, NOTEQUALS, IZBRANCH, 10, ONEMINUS, ICHARLIT, 8, EMIT, 0xCB,0x87, ICHARLIT, 8, EMIT, IBRANCH, 13, DUP, TWOOVER, NOTEQUALS, IZBRANCH, 7, EMIT, OVER, CSTORE, ONEPLUS, IBRANCH, 2, TWODROP, IBRANCH, -50, DROP, NIP, SWAP, MINUS, EXIT,
...
0xC6,0x7C, 0xCA,0x38, DROP, CFETCH, EXIT,
...
0xC6,0x7C, 0xCA,0x38, DUP, ZEROEQUALS, IZBRANCH, 2, ABORT, TUCK, OVER, PLUS, ONEMINUS, DUP, CFETCH, ICHARLIT, 128, OR, 0xC6,0x8B, TWODUP, NOTEQUALS, IZBRANCH, 8, ONEMINUS, DUP, CFETCH, 0xC6,0x8B, IBRANCH, -10, TWODROP, 0xC8,0xFE, 0xC0,0x56, SWAP, 0xC6,0x8B, 0xC2,0xB4, FETCH, 0xC3,0x62, 0xC2,0xB4, STORE, ICHARLIT, DOCREATE, 0xC6,0x8B, 0xC6,0x41, EXIT,
...
BASE, FETCH, TOR, 0xC9,0x09, QDUP, IZBRANCH, 98, TWODUP, ICHARLIT, 16, MIN, TUCK, 0xC7,0x31, OVER, ZERO, 0xC5,0x27, 0xC3,0x8C, 0xC3,0x8C, 0xC3,0x8C, 0xC3,0x8C, 0xC3,0x8C, 0xC3,0x8C, 0xC3,0x8C, 0xC3,0x8C, 0xC3,0xA5, 0xCC,0x2F, ICHARLIT, 2, 0xCB,0x95, DUP, ZERO, PDO, OVER, I, PLUS, CFETCH, ZERO, 0xC5,0x27, 0xC3,0x8C, 0xC3,0x8C, 0xC3,0xA5, 0xCC,0x2F, 0xCB,0x87, PILOOP, -18, ICHARLIT, 16, OVER, MINUS, ICHARLIT, 3, 0xC3,0xEA, 0xCB,0x95, 0xCB,0x87, ZERO, PDO, DUP, I, PLUS, CFETCH, DUP, ICHARLIT, 32, LESSTHAN, OVER, ICHARLIT, 127, GREATERTHAN, OR, IZBRANCH, 4, DROP, ICHARLIT, '.', EMIT, PILOOP, -20, DROP, 0xC4,0x77, IBRANCH, -99, RFROM, BASE, STORE, EXIT,
...
ICHARLIT, BRANCH, 0xC6,0xE6, 0xC8,0xFE, ZERO, 0xC6,0x8B, SWAP, 0xCC,0x10, EXIT,
...
VM, ICHARLIT, offsetof(EnforthVM, last_ffi), PLUS, FETCH, QDUP, IZBRANCH, 14, DUP, 0xC1,0x20, OVER, 0xC1,0x29, 0xC2,0x92, 0xCB,0x87, IFETCH, IBRANCH, -15, EXIT,
...
0x80|'Y', 'E', 'K',
#undef ROMDEF_LAST
#define ROMDEF_KEY 0xC960
#define ROMDEF_LAST 0xC960
3, 0xC9,0x59, DOCOLONROM,
PAUSE, KEYQ, IZBRANCH, -3, PKEY, EXIT,

/* KEYQ */
0x80|'?', 'Y', 'E', 'K',
#undef ROMDEF_LAST
#define ROMDEF_KEYQ 0xC96E
...
0x80|'E', 'V', 'A', 'E', 'L',
#undef ROMDEF_LAST
#define ROMDEF_LEAVE 0xC977
#define ROMDEF_LAST 0xC977
...
0x80|'L', 'A', 'R', 'E', 'T', 'I', 'L',
#undef ROMDEF_LAST
#define ROMDEF_LITERAL 0xC99C
#define ROMDEF_LAST 0xC99C
0x80|7, 0xC9,0x77, DOCOLONROM,
...
0x80|'D', 'A', 'O', 'L',
#undef ROMDEF_LAST
#define ROMDEF_LOAD 0xC9BB
#define ROMDEF_LAST 0xC9BB
4, 0xC9,0x9C, LOAD,

/* LOOP */
0x80|'P', 'O', 'O', 'L',
#undef ROMDEF_LAST
#define ROMDEF_LOOP 0xC9C3
#define ROMDEF_LAST 0xC9C3
0x80|4, 0xC9,0xBB, DOCOLONROM,
ICHARLIT, PLOOP, 0xC0,0xF4, EXIT,

/* LSHIFT */
0x80|'T', 'F', 'I', 'H', 'S', 'L',
#undef ROMDEF_LAST
#define ROMDEF_LSHIFT 0xC9D2
...
0x80|'*', 'M',
#undef ROMDEF_LAST
#define ROMDEF_MSTAR 0xC9D8
#define ROMDEF_LAST 0xC9D8
2, 0xC9,0xD2, DOCOLONROM,
TWODUP, XOR, ZEROLESS, TOR, ABS, SWAP, ABS, UMSTAR, RFROM, 0xC0,0x61, EXIT,

/* MPLUS */
0x80|'+', 'M',
#undef ROMDEF_LAST
#define ROMDEF_MPLUS 0xC9EA
#define ROMDEF_LAST 0xC9EA
2, 0xC9,0xD8, MPLUS,

/* MAX */
0x80|'X', 'A', 'M',
#undef ROMDEF_LAST
#define ROMDEF_MAX 0xC9F1
#define ROMDEF_LAST 0xC9F1
3, 0xC9,0xEA, MAX,

/* MIN */
0x80|'N', 'I', 'M',
#undef ROMDEF_LAST
#define ROMDEF_MIN 0xC9F8
#define ROMDEF_LAST 0xC9F8
3, 0xC9,0xF1, MIN,

/* MOD */
0x80|'D', 'O', 'M',
#undef ROMDEF_LAST
#define ROMDEF_MOD 0xC9FF
#define ROMDEF_LAST 0xC9FF
3, 0xC9,0xF8, DOCOLONROM,
0xC4,0x65, DROP, EXIT,

/* MOVE */
0x80|'E', 'V', 'O', 'M',
#undef ROMDEF_LAST
#define ROMDEF_MOVE 0xCA0B
...
0x80|'E', 'T', 'A', 'G', 'E', 'N',
#undef ROMDEF_LAST
#define ROMDEF_NEGATE 0xCA15
#define ROMDEF_LAST 0xCA15
6, 0xCA,0x0B, NEGATE,

/* NIP */
0x80|'P', 'I', 'N',
#undef ROMDEF_LAST
#define ROMDEF_NIP 0xCA1C
#define ROMDEF_LAST 0xCA1C
3, 0xCA,0x15, NIP,

/* OR */
0x80|'R', 'O',
#undef ROMDEF_LAST
#define ROMDEF_OR 0xCA22
...
0x80|'R', 'E', 'V', 'O',
#undef ROMDEF_LAST
#define ROMDEF_OVER 0xCA2A
#define ROMDEF_LAST 0xCA2A
4, 0xCA,0x22, OVER,

/* PARSEWORD */
0x80|'D', 'R', 'O', 'W', '-', 'E', 'S', 'R', 'A', 'P',
#undef ROMDEF_LAST
#define ROMDEF_PARSEWORD 0xCA38
#define ROMDEF_LAST 0xCA38
10, 0xCA,0x2A, DOCOLONROM,
TOR, 0xCB,0x78, 0xC5,0x5A, FETCH, 0xC4,0x77, RFETCH, TOR, OVER, CFETCH, RFETCH, EQUALS, OVER, AND, IZBRANCH, 7, ICHARLIT, 1, 0xC4,0x77, IBRANCH, -13, RFROM, DROP, OVER, SWAP, RFROM, TOR, DUP, ZEROEQUALS, IZBRANCH, 6, RFROM, TWODROP, FALSE, IBRANCH, 18, OVER, CFETCH, RFETCH, EQUALS, IZBRANCH, 6, RFROM, TWODROP, TRUE, IBRANCH, 7, ICHARLIT, 1, 0xC4,0x77, IBRANCH, -25, OVER, 0xCB,0x78, DROP, MINUS, SWAP, IZBRANCH, 2, ONEPLUS, 0xC5,0x5A, STORE, OVER, MINUS, EXIT,

/* PAUSE */
0x80|'E', 'S', 'U', 'A', 'P',
#undef ROMDEF_LAST
#define ROMDEF_PAUSE 0xCA88
...
#undef ROMDEF_LAST
#define ROMDEF_POSTPONE 0xCA94
#define ROMDEF_LAST 0xCA94
0x80|8, 0xCA,0x88, DOCOLONROM,
0xC6,0x7C, 0xCA,0x38, 0xC1,0x60, QDUP, ZEROEQUALS, IZBRANCH, 11, 0xCC,0x2F, 0xCB,0x87, ICHARLIT, '?', EMIT, 0xC7,0x31, ABORT, ZEROLESS, IZBRANCH, 19, ICHARLIT, LIT, 0xC6,0xE6, 0xC4,0x25, ICHARLIT, ((uint8_t)((ROMDEF_COMPILECOMMA >> 8) & 0xff)), ICHARLIT, 8, LSHIFT, ICHARLIT, ((uint8_t)((ROMDEF_COMPILECOMMA     ) & 0xff)), OR, 0xC3,0x62, IBRANCH, 3, 0xC6,0xE6, EXIT,

/* QUIT */
0x80|'T', 'I', 'U', 'Q',
#undef ROMDEF_LAST
#define ROMDEF_QUIT 0xCAC8
#define ROMDEF_LAST 0xCAC8
4, 0xCA,0x94, DOCOLONROM,
INITRP, ZERO, 0xCB,0xA7, STORE, 0xC3,0x37, DUP, 0xC3,0x40, 0xC5,0xEA, 0xCB,0x87, 0xC2,0x4F, 0xC7,0x31, 0xCB,0xA7, FETCH, ZEROEQUALS, IZBRANCH, 8, PISQUOTE, 3, 'o', 'k', ' ', 0xC2,0x92, IBRANCH, -27,

/* RFROM */
0x80|'>', 'R',
#undef ROMDEF_LAST
#define ROMDEF_RFROM 0xCAEF
#define ROMDEF_LAST 0xCAEF
2, 0xCA,0xC8, RFROM,

/* RFETCH */
0x80|'@', 'R',
#undef ROMDEF_LAST
#define ROMDEF_RFETCH 0xCAF5
...
0x80|'T', 'A', 'E', 'P', 'E', 'R',
#undef ROMDEF_LAST
#define ROMDEF_REPEAT 0xCAFF
#define ROMDEF_LAST 0xCAFF
0x80|6, 0xCA,0xF5, DOCOLONROM,
0xC6,0x2E, 0xCC,0x10, EXIT,

/* ROT */
0x80|'T', 'O', 'R',
#undef ROMDEF_LAST
#define ROMDEF_ROT 0xCB0B
...
0x80|'"', 'S',
#undef ROMDEF_LAST
#define ROMDEF_SQUOTE 0xCB1B
#define ROMDEF_LAST 0xCB1B
0x80|2, 0xCB,0x15, DOCOLONROM,
ICHARLIT, '"', 0xCA,0x38, ICHARLIT, PSQUOTE, 0xC6,0xE6, DUP, 0xC6,0x8B, 0xC8,0xFE, OVER, 0xC6,0x57, SWAP, MOVE, EXIT,

/* STOD */
0x80|'D', '>', 'S',
#undef ROMDEF_LAST
#define ROMDEF_STOD 0xCB35
#define ROMDEF_LAST 0xCB35
3, 0xCB,0x1B, DOCOLONROM,
DUP, ZEROLESS, EXIT,

/* SAVE */
0x80|'E', 'V', 'A', 'S',
#undef ROMDEF_LAST
#define ROMDEF_SAVE 0xCB40
...
0x80|'N', 'G', 'I', 'S',
#undef ROMDEF_LAST
#define ROMDEF_SIGN 0xCB48
#define ROMDEF_LAST 0xCB48
4, 0xCB,0x40, DOCOLONROM,
ZEROLESS, IZBRANCH, 5, ICHARLIT, '-', 0xC9,0x16, EXIT,

/* SMSLASHREM */
0x80|'M', 'E', 'R', '/', 'M', 'S',
#undef ROMDEF_LAST
#define ROMDEF_SMSLASHREM 0xCB5A
#define ROMDEF_LAST 0xCB5A
6, 0xCB,0x48, DOCOLONROM,
OVER, TOR, TWODUP, XOR, TOR, ABS, TOR, 0xC7,0x95, RFROM, UMSLASHMOD, RFROM, 0xC0,0x6B, SWAP, RFROM, 0xC0,0x6B, SWAP, EXIT,

/* SOURCE */
0x80|'E', 'C', 'R', 'U', 'O', 'S',
#undef ROMDEF_LAST
#define ROMDEF_SOURCE 0xCB78
#define ROMDEF_LAST 0xCB78
6, 0xCB,0x5A, DOCOLONROM,
VM, ICHARLIT, offsetof(EnforthVM, source_len), PLUS, TWOFETCH, EXIT,

/* SPACE */
0x80|'E', 'C', 'A', 'P', 'S',
#undef ROMDEF_LAST
#define ROMDEF_SPACE 0xCB87
#define ROMDEF_LAST 0xCB87
5, 0xCB,0x78, DOCOLONROM,
0xC6,0x7C, EMIT, EXIT,

/* SPACES */
0x80|'S', 'E', 'C', 'A', 'P', 'S',
#undef ROMDEF_LAST
#define ROMDEF_SPACES 0xCB95
#define ROMDEF_LAST 0xCB95
6, 0xCB,0x87, DOCOLONROM,
QDUP, IZBRANCH, 6, 0xCB,0x87, ONEMINUS, IBRANCH, -7, EXIT,

/* STATE */
0x80|'E', 'T', 'A', 'T', 'S',
#undef ROMDEF_LAST
#define ROMDEF_STATE 0xCBA7
#define ROMDEF_LAST 0xCBA7
5, 0xCB,0x95, DOCOLONROM,
VM, ICHARLIT, offsetof(EnforthVM, state), PLUS, EXIT,

/* SWAP */
0x80|'P', 'A', 'W', 'S',
#undef ROMDEF_LAST
#define ROMDEF_SWAP 0xCBB4
...
0x80|'K', 'S', 'A', 'T',
#undef ROMDEF_LAST
#define ROMDEF_TASK 0xCBBC
#define ROMDEF_LAST 0xCBBC
4, 0xCB,0xB4, DOCOLONROM,
...
0x80|'N', 'E', 'H', 'T',
#undef ROMDEF_LAST
#define ROMDEF_THEN 0xCC10
#define ROMDEF_LAST 0xCC10
0x80|4, 0xCB,0xBC, DOCOLONROM,
0xC8,0xFE, OVER, MINUS, SWAP, CSTORE, EXIT,

/* TRUE */
0x80|'E', 'U', 'R', 'T',
#undef ROMDEF_LAST
#define ROMDEF_TRUE 0xCC1F
...
0x80|'E', 'P', 'Y', 'T',
#undef ROMDEF_LAST
#define ROMDEF_TYPE 0xCC2F
#define ROMDEF_LAST 0xCC2F
4, 0xCC,0x27, DOCOLONROM,
OVER, PLUS, SWAP, TWODUP, NOTEQUALS, IZBRANCH, 7, DUP, CFETCH, EMIT, ONEPLUS, IBRANCH, -9, TWODROP, EXIT,

/* UDOT */
0x80|'.', 'U',
#undef ROMDEF_LAST
#define ROMDEF_UDOT 0xCC44
#define ROMDEF_LAST 0xCC44
2, 0xCC,0x2F, DOCOLONROM,
ZERO, 0xC5,0x27, 0xC3,0xB8, 0xC3,0xA5, 0xCC,0x2F, 0xCB,0x87, EXIT,

/* ULESSTHAN */
0x80|'<', 'U',
#undef ROMDEF_LAST
#define ROMDEF_ULESSTHAN 0xCC56
#define ROMDEF_LAST 0xCC56
2, 0xCC,0x44, ULESSTHAN,

/* UGREATERTHAN */
0x80|'>', 'U',
#undef ROMDEF_LAST
#define ROMDEF_UGREATERTHAN 0xCC5C
#define ROMDEF_LAST 0xCC5C
2, 0xCC,0x56, UGREATERTHAN,

/* UDDOT */
0x80|'.', 'D', 'U',
#undef ROMDEF_LAST
#define ROMDEF_UDDOT 0xCC63
#define ROMDEF_LAST 0xCC63
3, 0xCC,0x5C, DOCOLONROM,
0xC5,0x27, 0xC3,0xB8, 0xC3,0xA5, 0xCC,0x2F, 0xCB,0x87, EXIT,

/* UMSTAR */
0x80|'*', 'M', 'U',
#undef ROMDEF_LAST
#define ROMDEF_UMSTAR 0xCC75
...
0x80|'D', 'O', 'M', '/', 'M', 'U',
#undef ROMDEF_LAST
#define ROMDEF_UMSLASHMOD 0xCC7F
#define ROMDEF_LAST 0xCC7F
6, 0xCC,0x75, UMSLASHMOD,

/* UNLOOP */
0x80|'P', 'O', 'O', 'L', 'N', 'U',
#undef ROMDEF_LAST
#define ROMDEF_UNLOOP 0xCC89
#define ROMDEF_LAST 0xCC89
6, 0xCC,0x7F, UNLOOP,

/* UNUSED */
0x80|'D', 'E', 'S', 'U', 'N', 'U',
#undef ROMDEF_LAST
#define ROMDEF_UNUSED 0xCC93
#define ROMDEF_LAST 0xCC93
6, 0xCC,0x89, DOCOLONROM,
...
0x80|':', 'E', 'S', 'U',
#undef ROMDEF_LAST
#define ROMDEF_USE 0xCCAA
#define ROMDEF_LAST 0xCCAA
4, 0xCC,0x93, DOCOLONROM,
0xC6,0x7C, 0xCA,0x38, DUP, ZEROEQUALS, IZBRANCH, 2, ABORT, TWODUP, 0xC1,0x3A, ZEROEQUALS, IZBRANCH, 11, 0xCC,0x2F, 0xCB,0x87, ICHARLIT, '?', EMIT, 0xC7,0x31, ABORT, 0xC8,0xFE, 0xC0,0x56, ROT, ICHARLIT, 32, OR, 0xC6,0x8B, 0xC2,0xB4, FETCH, 0xC3,0x62, 0xC2,0xB4, STORE, ICHARLIT, DOFFI0, OVER, 0xC1,0x17, PLUS, 0xC6,0x8B, 0xC6,0x41, 0xC4,0x25, DROP, EXIT,

/* VARIABLE */
0x80|'E', 'L', 'B', 'A', 'I', 'R', 'A', 'V',
#undef ROMDEF_LAST
#define ROMDEF_VARIABLE 0xCCEF
#define ROMDEF_LAST 0xCCEF
8, 0xCC,0xAA, DOCOLONROM,
0xC7,0x3F, ZERO, ONEMINUS, 0xC6,0x57, ICHARLIT, DOVARIABLE, 0xC6,0x8B, ZERO, 0xC4,0x25, EXIT,

/* WHILE */
0x80|'E', 'L', 'I', 'H', 'W',
#undef ROMDEF_LAST
#define ROMDEF_WHILE 0xCD06
#define ROMDEF_LAST 0xCD06
0x80|5, 0xCC,0xEF, DOCOLONROM,
0xC9,0x2B, SWAP, EXIT,

/* WORDS */
0x80|'S', 'D', 'R', 'O', 'W',
#undef ROMDEF_LAST
#define ROMDEF_WORDS 0xCD13
#define ROMDEF_LAST 0xCD13
5, 0xCD,0x06, DOCOLONROM,
0xC2,0xB4, FETCH, QDUP, IZBRANCH, 59, DUP, 0xC1,0x0C, IZBRANCH, 16, DUP, 0xC0,0x43, DUP, 0xC1,0x20, SWAP, 0xC1,0x29, 0xC2,0x92, 0xCB,0x87, IBRANCH, 35, DUP, 0xC0,0x78, ICHARLIT, 64, AND, ZEROEQUALS, IZBRANCH, 28, DUP, DUP, 0xC2,0xCE, OVER, SWAP, MINUS, SWAP, TWODUP, NOTEQUALS, IZBRANCH, 11, ONEMINUS, DUP, 0xC0,0x78, ICHARLIT, 127, AND, EMIT, IBRANCH, -13, TWODROP, 0xCB,0x87, 0xC2,0xBD, IBRANCH, -60, EXIT,

/* XOR */
0x80|'R', 'O', 'X',
#undef ROMDEF_LAST
#define ROMDEF_XOR 0xCD5B
#define ROMDEF_LAST 0xCD5B
3, 0xCD,0x13, XOR,

/* LTBRACKET */
0x80|'[',
#undef ROMDEF_LAST
#define ROMDEF_LTBRACKET 0xCD60
#define ROMDEF_LAST 0xCD60
0x80|1, 0xCD,0x5B, DOCOLONROM,
FALSE, 0xCB,0xA7, STORE, EXIT,

/* BRACKETTICK */
0x80|']', '\'', '[',
#undef ROMDEF_LAST
#define ROMDEF_BRACKETTICK 0xCD6C
#define ROMDEF_LAST 0xCD6C
0x80|3, 0xCD,0x60, DOCOLONROM,
0xC3,0xC6, ICHARLIT, LIT, 0xC6,0xE6, 0xC4,0x25, EXIT,

/* BRACKETCHAR */
0x80|']', 'R', 'A', 'H', 'C', '[',
#undef ROMDEF_LAST
#define ROMDEF_BRACKETCHAR 0xCD7F
#define ROMDEF_LAST 0xCD7F
0x80|6, 0xCD,0x6C, DOCOLONROM,
0xC6,0xBE, ICHARLIT, CHARLIT, 0xC6,0xE6, 0xC6,0x8B, EXIT,

/* BACKSLASH */
0x80|'\\',
#undef ROMDEF_LAST
#define ROMDEF_BACKSLASH 0xCD8D
#define ROMDEF_LAST 0xCD8D
0x80|1, 0xCD,0x7F, DOCOLONROM,
0xCB,0x78, NIP, 0xC5,0x5A, STORE, EXIT,

/* RTBRACKET */
0x80|']',
#undef ROMDEF_LAST
#define ROMDEF_RTBRACKET 0xCD99
#define ROMDEF_LAST 0xCD99
1, 0xCD,0x8D, DOCOLONROM,
TRUE, 0xCB,0xA7, STORE, EXIT,
