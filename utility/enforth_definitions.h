...
/* FOUNDFFIQ */
FFINAME, SWAP, QDUP, ZBRANCH, 21, ONEMINUS, TOR, OVER, CFETCH, OVER, CFETCHFFIDEFS, NOTEQUALS, ZBRANCH, 6, TWODROP, RFROM, DROP, FALSE, EXIT, ONEPLUS, SWAP, ONEPLUS, RFROM, BRANCH, -22, TWODROP, TRUE, EXIT, 0, 0,
